# Ingestion Events Specification

## Purpose
Defines the mechanism and guarantees for notifying downstream analytics and intelligence services when new batches of continuous data become available.
