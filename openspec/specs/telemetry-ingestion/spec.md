...
## Purpose
Defines the capabilities and expectations for consuming raw MQTT telemetry streams, validating payloads, buffering data in memory, and bulk-inserting time-series events into the database.
