...
## Purpose
Defines the capabilities and expectations for managing PostgreSQL relational tables corresponding to core system models (Auth, Disease, Anomaly) utilizing Prisma ORM.
